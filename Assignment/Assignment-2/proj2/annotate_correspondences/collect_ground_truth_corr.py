...
class CorrespondenceAnnotator(object):
	def __init__(self):
		...
		self.image1 = load_image(r'Assignment/Assignment-2/proj2/data/Mount Rushmore/9021235130_7c2acd9554_o.jpg')
		self.image2 = load_image(r'Assignment/Assignment-2/proj2/data/Mount Rushmore/9318872612_a255c874fb_o.jpg')
		self.corr_file = Path(r'Assignment/Assignment-2/proj2/data/Mount Rushmore/mount_rushmore_correspondences.pkl')
